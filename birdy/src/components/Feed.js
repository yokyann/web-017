        ...
        <ul class="text-center divide-x divide-gray-800 rounded-lg flex ">
          <li class="w-full">
            <button
              ...
              className={
                props.setUserOnly
                  ? "bg-gray-200 w-full p-4 rounded-tl-lg  hover:bg-gray-300 focus:outline-none  "
                  : "bg-gray-300 w-full p-4 rounded-tl-lg  hover:bg-gray-300 focus:outline-none"
              }
            >
              Messages
            </button>
          ...
          <li class="w-full">
            <button
              ...
              className=" w-full p-4 rounded-tr-lg bg-gray-200 hover:bg-gray-300 focus:outline-none"
            >
              Users
            </button>
          </li>
      ...
      {props.userOnly ? (
        ...
        <div>
          <div className="my-2">
            ...
            <button
              className="border p-2 my-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
            ...
            <div>
              <ul class="text-center divide-x divide-gray-800 rounded-lg flex ">
                <li class="w-full">
                  <button
                    onClick={handleAll}
                    className=" w-full p-4 rounded-tl-lg bg-gray-200 hover:bg-gray-300 focus:outline-none"
                  >
                    All
                  </button>
                </li>
